...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/02/22 17:04:56 by iarmonde          #+#    #+#             */
/*   Updated: 2026/02/22 17:04:56 by iarmonde         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
    ...
    if (ft_strnstr("abcdef", "ass", 6) == NULL)
        printf("Resultado: NULL (Correto!)\n");
    else
    ...
    printf("\n====STRTRIM:====\n");
    printf("%s\n", ft_strtrim("tchuTchaTucha", "tuchu"));
